...
class MoveEvent(val creature: Thing, val sourcePosition: Vector = creature.position, val destination: Vector, val staminaScalar: Float = 1f, val silent: Boolean = false, override var timeLeft: Int = 1) : TemporalEvent {
    override val source: Thing = creature
