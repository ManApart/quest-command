...
class Activator(override val name: String, override val description: String = "", val soul: Soul = Soul(), private val triggers: List<Trigger> = listOf(), tags: List<String> = listOf(),  properties: Map<String, String> = HashMap()) : Target {
