...
class Location(override val name: String, private val description: String = "", val restricted: Boolean = false, val position: Position = Position(), val activators: List<String> = listOf(), val creatures: List<String> = listOf(), val items: List<String> = listOf(), val locations: NameSearchableList<Location> = NameSearchableList()) : Named {
