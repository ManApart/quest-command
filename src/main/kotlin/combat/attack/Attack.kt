...
//            display("$subject $verb at $defenderName.")
    ...
    private fun getAttackedParts(source: Target, sourcePart: LocationRecipe, target: TargetAim): List<LocationRecipe> {
    ...
    private fun getRange(source: Target, sourcePart: LocationRecipe) : Int {
    ...
    private fun processAttackHit(event: AttackEvent, attackedPart: LocationRecipe, subject: String, verb: String, defenderName: String, damageSource: String, defender: Combatant, offensiveDamage: Int) {
    ...
    private fun getOffensiveDamage(sourceCreature: Target, sourcePart: LocationRecipe, type: DamageType): Int {
        return when {
