...
class StartAttackEvent(override val source: Target, private val sourcePart: LocationRecipe, override val target: TargetAim, val type: DamageType, timeLeft: Int = -1) : Event, BattleAction {
