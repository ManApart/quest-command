...
class StartAttackEvent(val source: Creature, val sourcePart: BodyPart, val target: Target, private val targetPosition: TargetPosition, val type: AttackType, timeLeft: Int = -1) : Event, BattleAction {
    ...
    private fun calcTimeLeft(defaultTimeLeft: Int): Int {
        return if (defaultTimeLeft != -1){
            ...
            val weaponSize = (sourcePart.getEquippedWeapon()?.getRange()?.distance ?: 0) + 1
