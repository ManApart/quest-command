...
class ASimplePie : StoryEventResource {
    override val values: List<StoryEvent2> = listOf(
            StoryEvent2("A Simple Pie", 10, "I should pick up an Apple, which I could get by traveling to the Apple Tree.",
            ...
            StoryEvent2("A Simple Pie", 20, "I should slice the apple by using my dagger or something sharp on it.",
                    TriggeredEvent2(TakeItemEvent::class.java,
            ...
            StoryEvent2("A Simple Pie", 30, "I should use my dagger on the wheat in the Open Field to get some wheat.",
                    TriggeredEvent2(ItemPickedUpEvent::class.java,
            ...
            StoryEvent2("A Simple Pie", 40, "I should place this wheat in the chute at the top of the windmill.",
                    TriggeredEvent2(TakeItemEvent::class.java,
            ...
            StoryEvent2("A Simple Pie", 50, "I can now pickup flour from the grain bin on the first floor.",
                    TriggeredEvent2(TransferItemEvent::class.java,
            ...
            StoryEvent2("A Simple Pie", 60, "I should travel to farmer's hut and use a bucket on the well to get water.",
                    TriggeredEvent2(TakeItemEvent::class.java,
            ...
            StoryEvent2("A Simple Pie", 70, "I should use water on flour to make dough.",
                    TriggeredEvent2(TakeItemEvent::class.java,
            ...
            StoryEvent2("A Simple Pie", 80, "I should combine the sliced apple, dough, and a pie tin on the range in the Farmer's Hut Interior.",
                    TriggeredEvent2(TakeItemEvent::class.java,
            ...
            StoryEvent2("A Simple Pie", 90, "I should take the pie tin, light the range, and then type 'craft apple pie`.",
            ...
            StoryEvent2("A Simple Pie", 100, "I've baked an an Apple Pie! That was easier than expected!",
                    TriggeredEvent2(TakeItemEvent::class.java,
