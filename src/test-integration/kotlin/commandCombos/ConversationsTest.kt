...
class ConversationsTest {
    ...
    fun whereListener() {
        ...
        assertEquals("Farmer: I be here.", ChatHistoryManager.main.getLastOutput())
    }
    ...
    fun multipleMatchesPicksAtRandom() {
        ...
        CommandParser.parseCommand("w && speak with farmer")
        CommandParser.parseCommand("where are you?")
        assertEquals("Farmer: I be with you.", ChatHistoryManager.main.getLastOutput())
    }
    ...
    fun whereBeMe() {
        ...
        assertEquals("Farmer: You be in Farmer's Hut.", ChatHistoryManager.main.getLastOutput())
    }
    ...
    fun whatKanbaraCity() {
        ...
        assertEquals("Farmer: Kanbara City be a city.", ChatHistoryManager.main.getLastOutput())
    }
    ...
    fun whatLocationWithMultipleMatches() {
        ...
        assertEquals("Farmer: What you mean? You mean Kanbara Gate or Kanbara City?", ChatHistoryManager.main.getLastOutput())
    }
}